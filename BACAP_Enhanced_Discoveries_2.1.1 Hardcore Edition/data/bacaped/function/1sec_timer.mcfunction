...
execute as @a if score @s bac_ten_withers matches 64.. run advancement grant @s only bacaped:challenges/the_world_is_actually_ending
...
execute as @a[gamemode=!spectator,scores={bacaped_unlucky_hurt=1..}] run function bacaped:unlucky_hurt
