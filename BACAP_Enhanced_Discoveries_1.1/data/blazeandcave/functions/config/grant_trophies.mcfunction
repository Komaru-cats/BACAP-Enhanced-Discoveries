...
execute as @s[advancements={bacaped:adventure/sandpicious=true}] run function bc_rewards:trophy/adventure/sandpicious
...
execute as @s[advancements={bacaped:challenges/master_villager=true}] run function bc_rewards:trophy/challenges/master_villager
