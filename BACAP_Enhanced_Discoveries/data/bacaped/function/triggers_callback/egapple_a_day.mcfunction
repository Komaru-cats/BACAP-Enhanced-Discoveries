...
tellraw @s {"color":"gray","italic":true,"translate":"If you have just slept, and it says you have eaten an enchanted golden apple when you actually haven't yet, try running this trigger again in 10 seconds."}
