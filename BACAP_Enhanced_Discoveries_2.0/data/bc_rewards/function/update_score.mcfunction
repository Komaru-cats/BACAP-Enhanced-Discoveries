...
# Bacaped
execute as @a[advancement={bacaped:adventure/advancement_info=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/din_don=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/emerald_armor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/eye_contact_master=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/fake_netherite_armor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/general_cleaning=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/i_hate_all_of_you=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/jurassic_park=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/komaru=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/midnight_snack=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/my_personal_slave=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/not_profitable_transportation=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/no_water_team=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/oh_you_again=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/on_site_sale=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/placeholder=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/real_netherite_armor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/restoring_population=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/silent_armor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/supply_chain=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/suspicious_miner=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/sus_miner=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/the_beginning_of_the_day=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/uncontrolled_reproduction=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/water_dependent=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:adventure/water_team=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/a_ewe_for_every_hue=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/hot=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/i_love_salmons=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/live_salmon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/more_colorful_wool=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/skill_issue=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/sniffer-sniff-event=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/the_invisible_turtle=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/the_wool_magnate=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:animal/youre_part_of_a_hive_mind_now=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/good_dreams=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/ice_sculptor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/my_mountains=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/stop_there_youre_tall_enough=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/the_boatman=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:biomes/the_infernal_cauldron=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:building/art_lover=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:building/potception=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:building/pot_on_a_pot=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:building/statue=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/5g_connectivity=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/5_birds_1_stone=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/astronomer=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/big_horse_adventure=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/celestial_protocol=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/dragon_vs_wither_iv=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/end_of_the_world_as_we_know_it=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/explosive_elexir=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/extincion=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/happy_anniversary=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/happy_minecraft_year=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/how_did_you_end_up_here=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/magic_kingdom=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/oh_my_broken_legs=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/professional_assassin=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/raise_the_stakes=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/show_the_nether_to_a_silverfish=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/so_bright=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/star_fisherman=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/the_apocalyptic_decalogy=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/the_king_of_the_redskins=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/the_world_is_actually_ending_2=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/void_being=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/what_are_the_chances=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/what_a_stupid_purchase=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/yes=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:challenges/zero_coordinates_magnet=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/all_the_netherite_tools=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/master_shearer=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/master_shieldman=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/master_sweeper=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/oh_i_forgot_about_the_anvil=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/pyromaniac=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:enchanting/useless=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:end/bee_colonist=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:end/endergardener=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:end/last_hit=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/apple_addiction=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/christmas_spirit=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/eco_warrior=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/golems=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/more_more_cookies=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/not_a_fireflies=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:farming/plant_enthusiast=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/batman=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/copper_king=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/deepslated_miner=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/deepslate_master=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/light_at_the_end_of_the_tunnel=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/redstoner=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/reinforced_miner=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:mining/time_killer=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:monsters/get_out_of_my_sky=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:monsters/high_explosives=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:monsters/phantom_rider=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/bastion_robber=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/bastion_sweet_bastion=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/diamond_beacon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/emerald_beacon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/give_them_everything_they_want=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/gold_beacon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/impostor=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/iron_beacon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/netherite_beacon=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/never_careful_enough=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/show_the_wither_his_home=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:nether/withering_depths=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:potion/flashlight=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:potion/master_of_effects=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:potion/worst_cleric_in_the_world=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:redstone/more_optimisations=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:redstone/old_optimisations=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:redstone/what_do_you_know_about_pistons=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/absolutely_ablaze_journey=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/ancient_sorcerer_sage=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/artisan_adept=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/ascension_ace=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/chests_aficionado=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/chest_lover=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/climb_expert=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/craftsman_novice=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/culinary_delight_maestro=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/duo_dynamo=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/epic_capital_conqueror=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/eternal_vanguard=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/happy_1000_days=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/happy_chest_year=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/intercontinental_rail_nexus=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/jetsetter_of_the_skies=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/jungle_gymnast=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/ladder_legend=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/legendary_artisan=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/master_artificer=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/master_of_survival=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/mr_chester=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/my_chest=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/navigator_of_the_infinite_waters=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/resilient_centenarian=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/shulker_explorer=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/shulker_maestro=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/shulker_seeker=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/shulker_voyager=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/skyward_legs=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/sovereign_of_martial_shifting=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/storm_hog_pilgrim=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/survival_saga=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/survivors_hour=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/titan_of_olympian_gold_triumphs=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/wrath_of_the_western_frontier=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:statistics/your_legs_are_beat=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:weaponry/more_shields=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:weaponry/snow_fights=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:weaponry/the_explosive_adventure=true}] run scoreboard players add @s bac_advancements 1
execute as @a[advancement={bacaped:weaponry/unlucky=true}] run scoreboard players add @s bac_advancements 1
# Updates team scores
