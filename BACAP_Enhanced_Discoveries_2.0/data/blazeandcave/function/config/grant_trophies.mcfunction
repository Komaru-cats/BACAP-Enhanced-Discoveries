...
# Bacaped
execute as @s[advancement={bacaped:adventure/advancement_info=true}] run function bc_rewards:trophy/adventure/advancement_info
execute as @s[advancement={bacaped:adventure/din_don=true}] run function bc_rewards:trophy/adventure/din_don
execute as @s[advancement={bacaped:adventure/general_cleaning=true}] run function bc_rewards:trophy/adventure/general_cleaning
execute as @s[advancement={bacaped:adventure/i_hate_all_of_you=true}] run function bc_rewards:trophy/adventure/i_hate_all_of_you
execute as @s[advancement={bacaped:adventure/komaru=true}] run function bc_rewards:trophy/adventure/komaru
execute as @s[advancement={bacaped:adventure/midnight_snack=true}] run function bc_rewards:trophy/adventure/midnight_snack
execute as @s[advancement={bacaped:adventure/real_netherite_armor=true}] run function bc_rewards:trophy/adventure/real_netherite_armor
execute as @s[advancement={bacaped:adventure/restoring_population=true}] run function bc_rewards:trophy/adventure/restoring_population
execute as @s[advancement={bacaped:adventure/silent_armor=true}] run function bc_rewards:trophy/adventure/silent_armor
execute as @s[advancement={bacaped:adventure/suspicious_miner=true}] run function bc_rewards:trophy/adventure/suspicious_miner
execute as @s[advancement={bacaped:animal/a_ewe_for_every_hue=true}] run function bc_rewards:trophy/animal/a_ewe_for_every_hue
execute as @s[advancement={bacaped:animal/i_love_salmons=true}] run function bc_rewards:trophy/animal/i_love_salmons
execute as @s[advancement={bacaped:animal/sniffer-sniff-event=true}] run function bc_rewards:trophy/animal/sniffer-sniff-event
execute as @s[advancement={bacaped:animal/the_invisible_turtle=true}] run function bc_rewards:trophy/animal/the_invisible_turtle
execute as @s[advancement={bacaped:animal/the_wool_magnate=true}] run function bc_rewards:trophy/animal/the_wool_magnate
execute as @s[advancement={bacaped:animal/youre_part_of_a_hive_mind_now=true}] run function bc_rewards:trophy/animal/youre_part_of_a_hive_mind_now
execute as @s[advancement={bacaped:biomes/good_dreams=true}] run function bc_rewards:trophy/biomes/good_dreams
execute as @s[advancement={bacaped:biomes/the_infernal_cauldron=true}] run function bc_rewards:trophy/biomes/the_infernal_cauldron
execute as @s[advancement={bacaped:building/potception=true}] run function bc_rewards:trophy/building/potception
execute as @s[advancement={bacaped:challenges/5g_connectivity=true}] run function bc_rewards:trophy/challenges/5g_connectivity
execute as @s[advancement={bacaped:challenges/5_birds_1_stone=true}] run function bc_rewards:trophy/challenges/5_birds_1_stone
execute as @s[advancement={bacaped:challenges/astronomer=true}] run function bc_rewards:trophy/challenges/astronomer
execute as @s[advancement={bacaped:challenges/big_horse_adventure=true}] run function bc_rewards:trophy/challenges/big_horse_adventure
execute as @s[advancement={bacaped:challenges/celestial_protocol=true}] run function bc_rewards:trophy/challenges/celestial_protocol
execute as @s[advancement={bacaped:challenges/dragon_vs_wither_iv=true}] run function bc_rewards:trophy/challenges/dragon_vs_wither_iv
execute as @s[advancement={bacaped:challenges/end_of_the_world_as_we_know_it=true}] run function bc_rewards:trophy/challenges/end_of_the_world_as_we_know_it
execute as @s[advancement={bacaped:challenges/explosive_elexir=true}] run function bc_rewards:trophy/challenges/explosive_elexir
execute as @s[advancement={bacaped:challenges/extincion=true}] run function bc_rewards:trophy/challenges/extincion
execute as @s[advancement={bacaped:challenges/happy_anniversary=true}] run function bc_rewards:trophy/challenges/happy_anniversary
execute as @s[advancement={bacaped:challenges/happy_minecraft_year=true}] run function bc_rewards:trophy/challenges/happy_minecraft_year
execute as @s[advancement={bacaped:challenges/how_did_you_end_up_here=true}] run function bc_rewards:trophy/challenges/how_did_you_end_up_here
execute as @s[advancement={bacaped:challenges/magic_kingdom=true}] run function bc_rewards:trophy/challenges/magic_kingdom
execute as @s[advancement={bacaped:challenges/oh_my_broken_legs=true}] run function bc_rewards:trophy/challenges/oh_my_broken_legs
execute as @s[advancement={bacaped:challenges/professional_assassin=true}] run function bc_rewards:trophy/challenges/professional_assassin
execute as @s[advancement={bacaped:challenges/raise_the_stakes=true}] run function bc_rewards:trophy/challenges/raise_the_stakes
execute as @s[advancement={bacaped:challenges/show_the_nether_to_a_silverfish=true}] run function bc_rewards:trophy/challenges/show_the_nether_to_a_silverfish
execute as @s[advancement={bacaped:challenges/so_bright=true}] run function bc_rewards:trophy/challenges/so_bright
execute as @s[advancement={bacaped:challenges/star_fisherman=true}] run function bc_rewards:trophy/challenges/star_fisherman
execute as @s[advancement={bacaped:challenges/the_apocalyptic_decalogy=true}] run function bc_rewards:trophy/challenges/the_apocalyptic_decalogy
execute as @s[advancement={bacaped:challenges/the_king_of_the_redskins=true}] run function bc_rewards:trophy/challenges/the_king_of_the_redskins
execute as @s[advancement={bacaped:challenges/the_world_is_actually_ending_2=true}] run function bc_rewards:trophy/challenges/the_world_is_actually_ending_2
execute as @s[advancement={bacaped:challenges/void_being=true}] run function bc_rewards:trophy/challenges/void_being
execute as @s[advancement={bacaped:challenges/what_are_the_chances=true}] run function bc_rewards:trophy/challenges/what_are_the_chances
execute as @s[advancement={bacaped:challenges/what_a_stupid_purchase=true}] run function bc_rewards:trophy/challenges/what_a_stupid_purchase
execute as @s[advancement={bacaped:challenges/yes=true}] run function bc_rewards:trophy/challenges/yes
execute as @s[advancement={bacaped:challenges/zero_coordinates_magnet=true}] run function bc_rewards:trophy/challenges/zero_coordinates_magnet
execute as @s[advancement={bacaped:enchanting/all_the_netherite_tools=true}] run function bc_rewards:trophy/enchanting/all_the_netherite_tools
execute as @s[advancement={bacaped:end/last_hit=true}] run function bc_rewards:trophy/end/last_hit
execute as @s[advancement={bacaped:farming/apple_addiction=true}] run function bc_rewards:trophy/farming/apple_addiction
execute as @s[advancement={bacaped:farming/eco_warrior=true}] run function bc_rewards:trophy/farming/eco_warrior
execute as @s[advancement={bacaped:farming/more_more_cookies=true}] run function bc_rewards:trophy/farming/more_more_cookies
execute as @s[advancement={bacaped:farming/plant_enthusiast=true}] run function bc_rewards:trophy/farming/plant_enthusiast
execute as @s[advancement={bacaped:mining/copper_king=true}] run function bc_rewards:trophy/mining/copper_king
execute as @s[advancement={bacaped:mining/deepslated_miner=true}] run function bc_rewards:trophy/mining/deepslated_miner
execute as @s[advancement={bacaped:mining/time_killer=true}] run function bc_rewards:trophy/mining/time_killer
execute as @s[advancement={bacaped:nether/diamond_beacon=true}] run function bc_rewards:trophy/nether/diamond_beacon
execute as @s[advancement={bacaped:nether/emerald_beacon=true}] run function bc_rewards:trophy/nether/emerald_beacon
execute as @s[advancement={bacaped:nether/give_them_everything_they_want=true}] run function bc_rewards:trophy/nether/give_them_everything_they_want
execute as @s[advancement={bacaped:nether/netherite_beacon=true}] run function bc_rewards:trophy/nether/netherite_beacon
execute as @s[advancement={bacaped:nether/show_the_wither_his_home=true}] run function bc_rewards:trophy/nether/show_the_wither_his_home
execute as @s[advancement={bacaped:potion/master_of_effects=true}] run function bc_rewards:trophy/potion/master_of_effects
execute as @s[advancement={bacaped:redstone/what_do_you_know_about_pistons=true}] run function bc_rewards:trophy/redstone/what_do_you_know_about_pistons
execute as @s[advancement={bacaped:statistics/absolutely_ablaze_journey=true}] run function bc_rewards:trophy/statistics/absolutely_ablaze_journey
execute as @s[advancement={bacaped:statistics/ancient_sorcerer_sage=true}] run function bc_rewards:trophy/statistics/ancient_sorcerer_sage
execute as @s[advancement={bacaped:statistics/ascension_ace=true}] run function bc_rewards:trophy/statistics/ascension_ace
execute as @s[advancement={bacaped:statistics/chests_aficionado=true}] run function bc_rewards:trophy/statistics/chests_aficionado
execute as @s[advancement={bacaped:statistics/culinary_delight_maestro=true}] run function bc_rewards:trophy/statistics/culinary_delight_maestro
execute as @s[advancement={bacaped:statistics/duo_dynamo=true}] run function bc_rewards:trophy/statistics/duo_dynamo
execute as @s[advancement={bacaped:statistics/epic_capital_conqueror=true}] run function bc_rewards:trophy/statistics/epic_capital_conqueror
execute as @s[advancement={bacaped:statistics/eternal_vanguard=true}] run function bc_rewards:trophy/statistics/eternal_vanguard
execute as @s[advancement={bacaped:statistics/happy_1000_days=true}] run function bc_rewards:trophy/statistics/happy_1000_days
execute as @s[advancement={bacaped:statistics/happy_chest_year=true}] run function bc_rewards:trophy/statistics/happy_chest_year
execute as @s[advancement={bacaped:statistics/intercontinental_rail_nexus=true}] run function bc_rewards:trophy/statistics/intercontinental_rail_nexus
execute as @s[advancement={bacaped:statistics/jetsetter_of_the_skies=true}] run function bc_rewards:trophy/statistics/jetsetter_of_the_skies
execute as @s[advancement={bacaped:statistics/ladder_legend=true}] run function bc_rewards:trophy/statistics/ladder_legend
execute as @s[advancement={bacaped:statistics/legendary_artisan=true}] run function bc_rewards:trophy/statistics/legendary_artisan
execute as @s[advancement={bacaped:statistics/master_artificer=true}] run function bc_rewards:trophy/statistics/master_artificer
execute as @s[advancement={bacaped:statistics/master_of_survival=true}] run function bc_rewards:trophy/statistics/master_of_survival
execute as @s[advancement={bacaped:statistics/mr_chester=true}] run function bc_rewards:trophy/statistics/mr_chester
execute as @s[advancement={bacaped:statistics/navigator_of_the_infinite_waters=true}] run function bc_rewards:trophy/statistics/navigator_of_the_infinite_waters
execute as @s[advancement={bacaped:statistics/shulker_maestro=true}] run function bc_rewards:trophy/statistics/shulker_maestro
execute as @s[advancement={bacaped:statistics/shulker_voyager=true}] run function bc_rewards:trophy/statistics/shulker_voyager
execute as @s[advancement={bacaped:statistics/skyward_legs=true}] run function bc_rewards:trophy/statistics/skyward_legs
execute as @s[advancement={bacaped:statistics/sovereign_of_martial_shifting=true}] run function bc_rewards:trophy/statistics/sovereign_of_martial_shifting
execute as @s[advancement={bacaped:statistics/storm_hog_pilgrim=true}] run function bc_rewards:trophy/statistics/storm_hog_pilgrim
execute as @s[advancement={bacaped:statistics/survival_saga=true}] run function bc_rewards:trophy/statistics/survival_saga
execute as @s[advancement={bacaped:statistics/titan_of_olympian_gold_triumphs=true}] run function bc_rewards:trophy/statistics/titan_of_olympian_gold_triumphs
execute as @s[advancement={bacaped:statistics/wrath_of_the_western_frontier=true}] run function bc_rewards:trophy/statistics/wrath_of_the_western_frontier
execute as @s[advancement={bacaped:statistics/your_legs_are_beat=true}] run function bc_rewards:trophy/statistics/your_legs_are_beat
execute as @s[advancement={bacaped:weaponry/more_shields=true}] run function bc_rewards:trophy/weaponry/more_shields
execute as @s[advancement={bacaped:weaponry/unlucky=true}] run function bc_rewards:trophy/weaponry/unlucky