...
execute as @a[advancements={bacaped:adventure/sandpicious=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={bacaped:adventure/water-dependent=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={bacaped:challenges/master_villager=true}] run scoreboard players add @s bac_advancements 1
...
execute as @a[advancements={bacaped:redstone/optimisations=true}] run scoreboard players add @s bac_advancements 1
