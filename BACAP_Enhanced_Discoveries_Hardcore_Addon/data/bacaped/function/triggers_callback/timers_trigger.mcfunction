...
execute if score @s bacaped_in_cave matches 1.. run tellraw @s {"color":"white","translate":"Time since last totem usage","extra":[{"text":": "},{"color":"gold","score":{"name":"@s","objective":"bacaped_time_since_last_totem_usage"}}]}
