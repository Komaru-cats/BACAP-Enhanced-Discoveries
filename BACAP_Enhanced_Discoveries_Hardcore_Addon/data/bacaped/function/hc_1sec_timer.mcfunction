...
execute as @a[gamemode=!spectator,advancements={bacaped:statistics/master_of_survival=false},scores={bacaped_time_since_last_totem_usage=180000..}] run advancement grant @s only bacaped:statistics/master_of_survival
execute as @a[gamemode=!spectator,advancements={bacaped:statistics/eternal_vanguard=false},scores={bacaped_time_since_last_totem_usage=720000..}] run advancement grant @s only bacaped:statistics/eternal_vanguard
