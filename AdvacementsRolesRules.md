...
As for the versions, at the moment any version above and including 2.5 is suitable. Later the criteria may change.
...
- The only gamerules you can modify are:
  - keepInventory/keep_inventory, which you are allowed to set to true
...
- Use mods that greatly facilitating the process of obtaining advancements
  - Examples of disallowed mods: X-Ray, Meteor Client (and any other cheat clients), Freecam and similar mods, mods that change weather cycle or rare mob loot
...
- Give yourself a "second chance" if you are playing Hardcore, because there is a different role - `Hardcore Enhanced Legend`. However, if you do this with the command in vanilla BACAP, you may still get the normal Enhanced Legend.
...
- Screenshot/video of the advancement at the moment of completion
### Yes.
